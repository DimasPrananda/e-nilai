<x-app-layout>
    <div class="p-4 md:p-12 flex-1" x-data="{ open: false }">
        ...
        <div class="md:p-0 mb-4">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-2">Kelola Data Jabatan</h1>
            <a href="{{ route('admin.dashboard') }}" class="text-gray-800 dark:text-gray-400 hover:dark:text-gray-200 hover:text-black">dashboard </a><a class="text-gray-800 dark:text-gray-200 font-bold">/ Kelola Data Jabatan</a>
        </div>
        
        <!-- Formulir Input Jabatan -->
        <form class="mb-4" action="{{ route('positions.store') }}" method="POST" x-show="open" x-transition>
            @csrf
            <div class="mb-4">
        ...
        <div class="flex flex-col bg-white p-5 dark:bg-gray-800 sm:rounded-lg">
            <div class="flex flex-1 justify-between items-center mb-4">
                <h2 class=" text-xl font-bold text-gray-800 dark:text-gray-200">Data Jabatan</h2>
                    ...
                    <tbody class="text-gray-800 dark:text-gray-200 dark:bg-gray-800 bg-white">
                        ...
                        <tr class=" border-b border-gray-300 dark:border-gray-700 dark:hover:bg-gray-800 hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <td class="flex justify-center text-center py-2">
                                <form action="{{ route('positions.destroy', $position->id) }}" class="inline-block relative group" method="POST" onsubmit="return confirm('Are you sure you want to delete this Position?');">
                                    @csrf
                                    @method('DELETE')
