...
<nav x-data="{ 
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden md:hidden">
        <div class="py-3 ">
            ...
            <x-responsive-nav-link :href="route('admin.karyawan.employees')" :active="request()->routeIs('admin.karyawan.employees')">
                {{ __('Data Karyawan') }}
            </x-responsive-nav-link>
            
            <x-responsive-nav-link :href="route('admin.penilaian.select-periods')" :active="request()->routeIs('admin.penilaian.select-periods')">
                {{ __('Penilaian') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link :href="route('admin.ranking.select-periods')" :active="request()->routeIs('admin.rangking.select-periods')">
                {{ __('Karyawan Terbaik') }}
            </x-responsive-nav-link>
